...
namespace DetectiveMysteryGamePlatform.Api.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlayerSessions_GameSessions_GameSessionId1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "text", nullable: false),
                    Description = table.Column<string>(type: "text", nullable: false),
                    IsPublicInfo = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Contents_Quests_QuestId",
                        column: x => x.QuestId,
                        principalTable: "Quests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Contents_Rounds_RoundId",
                        column: x => x.RoundId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contents_QuestId",
                table: "Contents",
                column: "QuestId");

            migrationBuilder.CreateIndex(
                name: "IX_Contents_RoundId",
                table: "Contents",
                column: "RoundId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlayerSessions_GameSessionId1",
                table: "PlayerSessions",
